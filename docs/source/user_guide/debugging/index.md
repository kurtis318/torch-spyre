...
| `SPYRE_VALIDATE_OP_SPECS=1` | Enables OpSpec invariant checking at each pipeline stage boundary (after creation, simplification, and unrolling). Catches invalid specs early with descriptive errors |
