...
| `SPYRE_INDUCTOR_LOG=1` | *Deprecated.* Use `SPYRE_LOGS="spyre.inductor:INFO"` instead |
| `SPYRE_INDUCTOR_LOG_LEVEL=DEBUG` | *Deprecated.* Use `SPYRE_LOGS="spyre.inductor:DEBUG"` instead |
